            ...
            {!auth ? (
              ...
              <>
                ...
                <NavDropdown title="Patient" id="patient-dropdown">
                  <NavDropdown.Item as={Link} to="/patientD">Add Patient</NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/patientlist">Cheak and Update Patient List</NavDropdown.Item>
                </NavDropdown>
              ...
              <NavDropdown title="Appointment" id="appointment-dropdown">
                <NavDropdown.Item as={Link} to="/appointmentlist">Cheack and Update Appointment List</NavDropdown.Item>
                <NavDropdown.Item as={Link} to="/appointmentD">Cheack and Update Appointment </NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Doctor" id="doctor-dropdown">
                  {/* <NavDropdown.Item as={Link} to="/role">Add Role</NavDropdown.Item> */}
                  <NavDropdown.Item as={Link} to="/roleD">Doctor List</NavDropdown.Item>
                </NavDropdown>

                <Link className='nav-link text-danger fw-bold' to="/login" onClick={handleLogout}>
                Logout ({auth?.firstName || "Doctor"})
                </Link>
              </>
            )}
          </Nav>
